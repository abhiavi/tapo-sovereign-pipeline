...
def main():
    print("Testing Kitchen camera with correct credentials...")
    try:
        ...
        if recordings:
            ...
            # Wait, HttpMediaSession hardcodes "admin". We must also monkey patch the username!
            # Since pytapo hasn't been successfully patched, we'll override HttpMediaSession class
